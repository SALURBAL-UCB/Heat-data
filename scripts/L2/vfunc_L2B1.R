...
BB <- BB%>%dplyr::filter(Country=="Argentina" | Country=="Colombia")
...
# save.image(file='pw_L2_1_leap.RData') 

load('pw_L2_1_leap.RData')
each_year_L2B1_leap=function(year){
  ...
  vv=as.data.frame(rep(values, each=194))
  colnames(vv)="date"
  ...
  dff=dff[-4]
  print(year)
  write.csv(dff,paste0("final_results/L2/L2_",year,"_B1.csv"))
  
}

start_time <- Sys.time()
each_year_L2B1_leap("2004")
each_year_L2B1_leap("2008")
each_year_L2B1_leap("2012")
end_time <- Sys.time()
end_time - start_time


#For years that are not leap
each_year_L2B1_1=function(year){
  grids=c((paste0(year,"_Q1.nc")), (paste0(year,"_Q2.nc")),(paste0(year,"_Q3.nc")), (paste0(year,"_Q4.nc")))
...
start_time <- Sys.time()
each_year_L2B1_1("2001")
each_year_L2B1_1("2002")
each_year_L2B1_1("2003")
each_year_L2B1_1("2005")
each_year_L2B1_1("2006")
each_year_L2B1_1("2007")
each_year_L2B1_1("2009")
each_year_L2B1_1("2010")
each_year_L2B1_1("2011")
each_year_L2B1_1("2013")
each_year_L2B1_1("2014")
each_year_L2B1_1("2015")
end_time <- Sys.time()
end_time - start_time
