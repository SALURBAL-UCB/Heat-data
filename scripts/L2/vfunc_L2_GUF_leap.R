...
# temp <- raster("2001_Q/2010_Q1.nc", varname='t2m')
...
each_year_L2_GUF_leap=function(year){
...
start_time <- Sys.time()
each_year_L2_GUF_leap("2004")
each_year_L2_GUF_leap("2008")
each_year_L2_GUF_leap("2012")
end_time <- Sys.time()
end_time - start_time
