...
each_year_L2B3_leap=function(year){
	...
	dff=dff[-4]
	print(year)
	write.csv(dff,paste0("L2/L2_",year,"_B3.csv"))
	
}

start_time <- Sys.time()
each_year_L2B3_leap("2001")
each_year_L2B3_leap("2002")
each_year_L2B3_leap("2003")
each_year_L2B3_leap("2005")
each_year_L2B3_leap("2006")
each_year_L2B3_leap("2007")
each_year_L2B3_leap("2009")
each_year_L2B3_leap("2010")
each_year_L2B3_leap("2011")
each_year_L2B3_leap("2013")
each_year_L2B3_leap("2014")
each_year_L2B3_leap("2015")
end_time <- Sys.time()
end_time - start_time
