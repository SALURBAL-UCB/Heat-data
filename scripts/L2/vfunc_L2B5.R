...
BB <- BB%>%dplyr::filter(Country=="El Salvador"|
                           Country=="Costa Rica" |
                           Country=="Guatemala" |
                           Country=="Nicaragua" |
                           Country=="Chile")
...
# save.image(file='pw_L2_5_leap.RData') 

load('pw_L2_5_leap.RData')
each_year_L2B5_leap=function(year){
  ...
  vv=as.data.frame(rep(values, each=163))
  colnames(vv)="date"
  ...
  dff=dff[-4]
  print(year)
  write.csv(dff,paste0("final_results/L2/L2_",year,"_B5.csv"))
  
}

start_time <- Sys.time()
each_year_L2B5_leap("2004")
each_year_L2B5_leap("2008")
each_year_L2B5_leap("2012")
end_time <- Sys.time()
end_time - start_time
...
each_year_L2B5_1=function(year){
  grids=c((paste0(year,"_Q1.nc")), (paste0(year,"_Q2.nc")),(paste0(year,"_Q3.nc")), (paste0(year,"_Q4.nc")))
...
start_time <- Sys.time()
each_year_L2B5_1("2001")
each_year_L2B5_1("2002")
each_year_L2B5_1("2003")
each_year_L2B5_1("2005")
each_year_L2B5_1("2006")
each_year_L2B5_1("2007")
each_year_L2B5_1("2009")
each_year_L2B5_1("2010")
each_year_L2B5_1("2011")
each_year_L2B5_1("2013")
each_year_L2B5_1("2014")
each_year_L2B5_1("2015")
end_time <- Sys.time()
end_time - start_time
